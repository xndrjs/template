...
export default function registerFeatureCoreDomainPrimitiveGenerator(
  plop: NodePlopAPI
) {
  plop.setGenerator("feature-core-domain-primitive", {
    description:
      "Add a Zod + @xndrjs/domain-zod primitive under core/domain/models/primitives/ (`<kebab>.primitive.ts`); choose scalar schema (string/number/boolean/date/uuid/bigint or custom `z.*`). See https://www.npmjs.com/package/@xndrjs/domain-zod",
    prompts: [
      {
        type: "list",
        name: "corePackageRel",
      ...
      },
      {
        ...
        name: "primitiveName",
        message:
          "Domain primitive base name (e.g. CustomerId). File will be `domain/models/primitives/<kebab>.primitive.ts`:",
